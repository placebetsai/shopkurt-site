async function shopifyAdmin(query, variables = {}) {
  const store = process.env.SHOPIFY_STORE || process.env.NEXT_PUBLIC_SHOPIFY_STORE || 'js0hy0-ux.myshopify.com';
  const token = process.env.SHOPIFY_ADMIN_TOKEN || process.env.NEXT_PUBLIC_SHOPIFY_TOKEN;
